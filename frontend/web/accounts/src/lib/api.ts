// Alleviare Central API Client & Gateway Interceptor (Accounts Portal)
...
export const api = {
  ...
  expenses: {
    ...
    approve: (id: string, role: string = 'ACCOUNTS') => fetchWithAuth<any>(`/expenses/${id}/approve?role=${role}`, { method: 'PATCH' })
  },
  orders: {
