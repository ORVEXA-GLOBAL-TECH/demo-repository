// Alleviare Central API Client & Gateway Interceptor (Sales Supervisor Portal)
...
export const api = {
  ...
  users: {
    ...
    getSupervisorTeam: (supervisorId: string) => fetchWithAuth<any[]>(`/users/supervisor/${supervisorId}/team`),
