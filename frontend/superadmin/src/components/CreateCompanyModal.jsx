...
const WIZARD_STEPS = [
  ...
  { id: 'modules', stepNum: 5, title: 'Pharma Modules', desc: 'Feature entitlements & tools', icon: Layers },
            ...
            {activeTab === 'modules' && (
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                  <div>
                    ...
                    <span style={{ fontSize: '0.74rem', color: '#64748b' }}>
                      Toggle modules available to field MRs and company managers
                    </span>
                  </div>
                  <button
                    type="button"
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '10px' }}>
                  {[
                    { key: 'dcr', label: 'Daily Call Reporting (DCR)', desc: 'Field MR doctor visits and chemist logs' },
                    { key: 'tourPlan', label: 'Tour Program & Scheduling', desc: 'Monthly tour calendar & approval' },
                    { key: 'gpsLiveTracking', label: 'Field GPS Live Tracking', desc: 'Real-time telemetry and geo-tagging' },
                    { key: 'doctorManagement', label: 'Doctor / HCP CRM', desc: 'Specialty, hospital & visit frequency' },
                    { key: 'chemistStockist', label: 'Chemist & Stockist Network', desc: 'Retailer tagging & secondary links' },
                    { key: 'orderManagement', label: 'Secondary Order Booking', desc: 'Direct stockist booking & price lists' },
                    { key: 'expenseManagement', label: 'Expense & Allowance (TA/DA)', desc: 'Mileage, DA, and claim approval' },
                    { key: 'sampleDistribution', label: 'Sample & Gift Distribution', desc: 'Batch number tracking & e-signs' },
                    { key: 'visualAids', label: 'Digital E-Detailing & Visual Aids', desc: 'Interactive tablet presentations' },
                    { key: 'aiAnalytics', label: 'AI Forecasting & Churn', desc: 'Predictive sales run-rates & insights' },
                    { key: 'whatsappAlerts', label: 'Automated WhatsApp & SMS', desc: 'Instant alerts to doctors & managers' },
                    { key: 'offlineSync', label: 'Offline Mobile Sync Engine', desc: 'Field visits without cellular network' }
                  ].map(mod => {
                    ...
                    return (
                      ...
                      >
                        ...
                        />
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontSize: '0.82rem', fontWeight: 700, color: isEnabled ? '#1e40af' : '#334155' }}>
                            {mod.label}
                          </div>
